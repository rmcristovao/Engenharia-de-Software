...
public abstract class DomainRoot_Base extends pt.ist.fenixframework.backend.jvstmojb.pstm.OneBoxDomainObject {
    ...
    public final static pt.ist.fenixframework.dml.runtime.RoleOne<pt.ist.fenixframework.DomainRoot,pt.tecnico.drivedb.domain.Manager> role$$manager = new pt.ist.fenixframework.dml.runtime.RoleOne<pt.ist.fenixframework.DomainRoot,pt.tecnico.drivedb.domain.Manager>() {
        @Override
        public pt.tecnico.drivedb.domain.Manager getValue(pt.ist.fenixframework.DomainRoot o1) {
            return ((DomainRoot_Base.DO_State)o1.get$obj$state(false)).manager;
        }
        @Override
        public void setValue(pt.ist.fenixframework.DomainRoot o1, pt.tecnico.drivedb.domain.Manager o2) {
            ((DomainRoot_Base.DO_State)o1.get$obj$state(true)).manager = o2;
        }
        public pt.ist.fenixframework.dml.runtime.Role<pt.tecnico.drivedb.domain.Manager,pt.ist.fenixframework.DomainRoot> getInverseRole() {
            return pt.tecnico.drivedb.domain.Manager.role$$root;
        }
    ...
    private final static class DomainRootHasDriveDBApplication {
        private static final pt.ist.fenixframework.backend.jvstmojb.pstm.LoggingRelation<pt.ist.fenixframework.DomainRoot,pt.tecnico.drivedb.domain.Manager> relation = new pt.ist.fenixframework.backend.jvstmojb.pstm.LoggingRelation<pt.ist.fenixframework.DomainRoot,pt.tecnico.drivedb.domain.Manager>(role$$manager, "DomainRootHasDriveDBApplication");
    }
    public static pt.ist.fenixframework.dml.runtime.DirectRelation<pt.ist.fenixframework.DomainRoot,pt.tecnico.drivedb.domain.Manager> getRelationDomainRootHasDriveDBApplication() {
        return DomainRootHasDriveDBApplication.relation;
    }
    
    static {
        DomainRootHasDriveDBApplication.relation.setRelationName("pt.ist.fenixframework.DomainRoot.DomainRootHasDriveDBApplication");
    }
    ...
    public void setManager(pt.tecnico.drivedb.domain.Manager manager) {
        getRelationDomainRootHasDriveDBApplication().add((pt.ist.fenixframework.DomainRoot)this, manager);
    }
